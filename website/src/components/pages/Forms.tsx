  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#111319] text-slate-900 dark:text-slate-100 p-4 md:p-8 font-sans transition-colors">
      <form onSubmit={handleSubmit(onSubmit)} className="max-w-5xl mx-auto space-y-6">
        ...
        <h1 className="text-2xl font-bold mb-4">Forms with Validation</h1>
        ...
        <div className="bg-[#7e3af2] p-3 rounded-lg flex justify-between items-center text-white text-sm shadow-md">
          ...
          <button type="button" className="hover:underline font-medium">View more →</button>
        </div>
          ...
          <div className="space-y-5">
            ...
            <div className="grid gap-1.5">
              ...
              <Input 
                ...
                className={`bg-white dark:bg-[#242933] border-gray-300 dark:border-gray-700 ${errors.name ? 'border-red-500 focus-visible:ring-red-500' : ''}`} 
              />
              ...
              <Controller
                ...
                render={({ field }) => (
                  <RadioGroup onValueChange={field.onChange} defaultValue={field.value} className="flex gap-6">
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="personal" id="personal" className="border-gray-400 text-purple-600" />
                      <Label htmlFor="personal" className="font-normal cursor-pointer">Personal</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem value="business" id="business" className="border-gray-400 text-purple-600" />
                      <Label htmlFor="business" className="font-normal cursor-pointer">Business</Label>
                    </div>
                  </RadioGroup>
                )}
            ...
            {/* Message (Textarea) */}
            <div className="grid gap-1.5">
              <Label htmlFor="message" className={errors.message ? "text-red-500" : ""}>Message</Label>
              <Textarea 
                {...register("message")}
                id="message"
                placeholder="Enter some long form content..."
                className={`min-h-[100px] bg-white dark:bg-[#242933] border-gray-300 dark:border-gray-700 ${errors.message ? 'border-red-500' : ''}`}
              />
            ...
            <div className="space-y-1.5">
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="privacy" className="text-sm font-normal text-gray-600 dark:text-gray-400">
                  I agree to the <span className="text-purple-600 hover:underline cursor-pointer">privacy policy</span>
                </Label>
              </div>
        ...
        <Card className="p-6 bg-gray-50 dark:bg-[#1a1d24] border-gray-200 dark:border-gray-800 space-y-8 shadow-sm">
          <div className="space-y-4">
            ...
            <div className="relative">
              <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 z-10" />
              <Input className="pl-10 bg-white dark:bg-[#242933]" placeholder="Icon left" />
            </div>
          </div>
          ...
          <div className="space-y-4">
            <h3 className="text-xs font-bold uppercase tracking-wider text-gray-500">Buttons</h3>
            <div className="flex w-full">
              <Button type="button" className="rounded-r-none bg-purple-600 shrink-0">Click</Button>
              <Input className="rounded-l-none bg-white dark:bg-[#242933]" placeholder="Input with button" />
            </div>
          </div>
        </Card>
      </form>
